...
Skillet.enchantSlot = {
    ...
    [7786] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Minor Beastslayer
    [7788] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Minor Striking
    [7745] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Minor Impact
    [7793] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Lesser Intellect
    ...
    [13378] = {4, 64, 0, "Shield"}, -- Enchant Shield - Minor Stamina
    [13380] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Lesser Spirit
    [13419] = {4, 30, 65536, "BACKSLOT"}, -- Enchant Cloak - Minor Agility
    [13421] = {4, 0, 65536, "BACKSLOT"}, -- Enchant Cloak - Lesser Protection
    [13464] = {4, 64, 0, "Shield"}, -- Enchant Shield - Lesser Protection
    [13485] = {4, 64, 0, "Shield"}, -- Enchant Shield - Lesser Spirit
    [13501] = {4, 31, 512, "WRISTSLOT"}, -- Enchant Bracer - Lesser Stamina
    [13503] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Lesser Striking
    [13522] = {4, 31, 65536, "BACKSLOT"}, -- Enchant Cloak - Lesser Shadow Resistance
    [13529] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Lesser Impact
    ...
    [13631] = {4, 64, 0, "Shield"}, -- Enchant Shield - Lesser Stamina
    ...
    [13653] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Lesser Beastslayer
    [13655] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Lesser Elemental Slayer
    [13657] = {4, 30, 65536, "BACKSLOT"}, -- Enchant Cloak - Fire Resistance
    [13659] = {4, 64, 0, "Shield"}, -- Enchant Shield - Spirit
    ...
    [13689] = {4, 64, 0, "Shield"}, -- Enchant Shield - Lesser Block
    [13693] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Striking
    [13695] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Impact
    ...
    [13817] = {4, 64, 0, "Shield"}, -- Enchant Shield - Stamina
    ...
    [13898] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Fiery Weapon
    [13905] = {4, 64, 0, "Shield"}, -- Enchant Shield - Greater Spirit
    [13915] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Demonslaying
    [13917] = {4, 31, 1048608, "CHESTSLOT"}, -- Enchant Chest - Superior Mana
    [13931] = {4, 30, 512, "WRISTSLOT"}, -- Enchant Bracer - Deflection
    [13933] = {4, 64, 0, "Shield"}, -- Enchant Shield - Frost Resistance
    [13935] = {4, 30, 256, "FEETSLOT"}, -- Enchant Boots - Agility
    [13937] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Greater Impact
    [13939] = {4, 30, 512, "WRISTSLOT"}, -- Enchant Bracer - Greater Strength
    [13941] = {4, 31, 1048608, "CHESTSLOT"}, -- Enchant Chest - Stats
    [13943] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Greater Striking
    ...
    [20017] = {4, 64, 0, "Shield"}, -- Enchant Shield - Greater Stamina
    ...
    [20016] = {4, 64, 0, "Shield"}, -- Enchant Shield - Superior Spirit
    [20029] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Icy Chill
    ...
    [20030] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Superior Impact
    [20033] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Unholy Weapon
    [20036] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Major Intellect
    [20031] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Superior Striking
    [20011] = {4, 30, 512, "WRISTSLOT"}, -- Enchant Bracer - Superior Stamina
    [20034] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Crusader
    [20025] = {4, 31, 1048608, "CHESTSLOT"}, -- Enchant Chest - Greater Stats
    [20032] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Lifestealing
    [20035] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Major Spirit
    [21931] = {2, 196083, 0, "Weapon"}, -- Enchant Weapon - Winter's Might
    [22749] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Spell Power
    [22750] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Healing Power
    [23799] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Strength
    [23800] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Agility
    [23801] = {4, 30, 512, "WRISTSLOT"}, -- Enchant Bracer - Mana Regeneration
    [23802] = {4, 30, 512, "WRISTSLOT"}, -- Enchant Bracer - Healing Power
    [23803] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Mighty Spirit
    [23804] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Mighty Intellect
    ...
    [27837] = {2, 1378, 0, "2H Weapon"}, -- Enchant 2H Weapon - Agility
    ...
    [27920] = {4, 0, 2048, "Ring"}, -- Enchant Ring - Striking
    [27924] = {4, 0, 2048, "Ring"}, -- Enchant Ring - Spellpower
    [27926] = {4, 0, 2048, "Ring"}, -- Enchant Ring - Healing Power
    [27927] = {4, 0, 2048, "Ring"}, -- Enchant Ring - Stats
    [27944] = {4, 64, 0, "Shield"}, -- Enchant Shield - Tough Shield
    [27945] = {4, 64, 0, "Shield"}, -- Enchant Shield - Intellect
    [27946] = {4, 64, 0, "Shield"}, -- Enchant Shield - Shield Block
    [27947] = {4, 64, 0, "Shield"}, -- Enchant Shield - Resistance
    ...
    [27967] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Major Striking
    [27968] = {2, 58867, 0, "Weapon"}, -- Enchant Weapon - Major Intellect
    [27972] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Potency
    [27971] = {2, 132450, 0, "2H Weapon"}, -- Enchant 2H Weapon - Savagery
    [27975] = {2, 173555, 0, "Weapon"}, -- Enchant Weapon - Major Spellpower
    [27977] = {2, 132450, 0, "2H Weapon"}, -- Enchant 2H Weapon - Major Agility
    [28004] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Battlemaster
    [28003] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Spellsurge
    [27984] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Mongoose
    [27981] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Sunfire
    [27982] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Soulfrost
    ...
    [34009] = {4, 64, 0, "Shield"}, -- Enchant Shield - Major Stamina
    [34010] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Major Healing
    [42620] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Greater Agility
    [42974] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Executioner
    [44383] = {4, 64, 0, "Shield"}, -- Enchant Shield - Resilience
    [46578] = {2, 189939, 0, "Weapon"}, -- Enchant Weapon - Deathfrost
