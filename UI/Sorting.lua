...
--
	if Skillet:GetTradeSkillOption("hideuncraftable") then
		if not (skill.numCraftable and skill.numCraftable > 0 and Skillet:GetTradeSkillOption("filterInventory-bag")) and
		   not (skill.numRecursive and skill.numRecursive > 0 and Skillet:GetTradeSkillOption("filterInventory-crafted")) and
		   not (skill.numCraftableVendor and skill.numCraftableVendor > 0 and Skillet:GetTradeSkillOption("filterInventory-vendor")) and
		   not (skill.numCraftableAlts and skill.numCraftableAlts > 0 and Skillet:GetTradeSkillOption("filterInventory-alts")) then
