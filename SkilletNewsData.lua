...
Skillet.NewsData = {
		...
		data = {
			{	name = "Changes",
				data = {
					...
					{ header = "UI", body = "Color Crafts in frame title" },
				},
			},
		},
	},
	{	version = "2.41",
		data = {
			{	name = "Changes",
				data = {
					{ header = "UI", body = "Partial fixes for stutter (issues #251 and #263)" },
				},
			},
		},
	},
	{	version = "2.40",
		data = {
			{	name = "Changes",
				data = {
					{ header = "Options", body = "Fix ShowOptions" },
				},
			},
		},
	},
	{	version = "2.39",
		data = {
			{	name = "Changes",
				data = {
					{ header = "TOC", body = "Update TOC" },
					{ header = "Errors", body = "Fix ADDON_ACTION_BLOCKED handling" },
				},
			},
		},
	},
